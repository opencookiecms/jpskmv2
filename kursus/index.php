...
if(!isset($_SESSION['sess_userFirstName']) || $role!="adminkursus"){
  header('Location: ../pages/homepage.php?err=2');
}
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="example1">
                  ...
                  <tbody>
                    ...
                    <?php do { ?> <tr>
                      ...
                      <td><?php echo $bil ; ?></td>
                      <td><a href="kursus?kusId=<?php echo $row_kursusView['kusId']; ?>"><?php echo $row_kursusView['KusName']; ?></a></td>
                      <td><?php echo $row_kursusView['KusBegin']; ?></td>
                      <td><?php echo $row_kursusView['kusEnd']; ?></td>
                      <td><?php echo $row_kursusView['kusTempat']; ?></td>
                      <td><?php echo $row_kursusView['kusTahun']; ?></td>
                      <td><?php echo $row_kursusView['kurHari']; ?></td>
                      <td><a href="e_kursus?kusId=<?php echo $row_kursusView['kusId']; ?>" class="btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></a> <a href="kurdel.php?kusId=<?php echo $row_kursusView['kusId']; ?>" class="btn btn-danger" role="button" onclick="return confirm('Anda Pasti?');" ><i class="fa fa-trash" aria-hidden="true"></i></a></td>



                    <?php } while ($row_kursusView = mysql_fetch_assoc($kursusView)); ?>
