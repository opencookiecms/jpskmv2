...
mysql_select_db($database_kcon, $kcon);
$query_viewkursus = "SELECT kursus.kusId, kursus.KusName, kursus.KusBegin, kursus.kusEnd, kursus.kusTempat, kursus.kusTahun, kursus.kurHari, users.usrName, users.usrIcNo, users.Jawatan, users.userUnit, users.GredJawatan, idjps.Kehadiran, idjps.hari FROM kursus, users, idjps WHERE idjps.usrId=users.usrId AND idjps.kusId=kursus.kusId AND kursus.kusId='$get2'";
              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="example1">
                ...
                <tbody>
                  ...
                  <?php do { ?><tr class="odd gradeX">
                    ...
                    <td><?php echo $row_viewkursus['Jawatan']; ?></td>
                    <td><?php echo $row_viewkursus['GredJawatan']; ?></td>
                    <td><?php echo $row_viewkursus['userUnit']; ?></td>
                    <td><?php echo $row_viewkursus['Kehadiran']; ?></td>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel">Kehadiran</h4>
                </div>
                <form method="POST" action="<?php echo $editFormAction; ?>" role="form" name="formkehadiranadd" class="form-horizontal">
                  <div class="modal-body">

                    <div class="form-group">
                      <div class="col-md-8">
                        <label>Nama</label>
                        <select name="pKehadiran" class="form-control">
                          <?php do { ?>
                            <option value="<?php echo $row_Recordset1['usrId']; ?>"><?php echo $row_Recordset1['usrName']; ?></option>
                    ...
                    <div class="form-group">
                      <div class="col-md-4">
                        ...
                        <select name="pDatang" class="form-control">
                    ...
                    <div class="form-group">
                      <div class="col-md-2">
                        ...
                        <input type="text" name="pHari" value="<?php echo $row_collecckr['kurHari']; ?>"  class="form-control" readonly>
                        <input type="text" name="pJumlah" value="<?php echo $row_collecckr['kurHari']; ?>" class="form-control hidden">
                      </div>
                      <div class="col-md-2">
                        <label>Kedatangan</label>


                        <input type="text" name="pJumlah" value="<?php echo $row_collecckr['kurHari']; ?>" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-md-2">

                        <input type="text" name="kurId" value="<?php echo $row_collecckr['kusId']; ?>"  class="form-control hidden">
                      </div>
                    </div>
                  ...
                  <input type="hidden" name="MM_insert" value="formkehadiranadd">
                </form>
              </div>
              <!-- /.box-body -->
            </div>
