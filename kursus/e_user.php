...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formUser")) {
  $updateSQL = sprintf("UPDATE users SET usrName=%s, usrIcNo=%s, Jawatan=%s, GredJawatan=%s, userUnit=%s, usersgroups=%s WHERE usrId=%s",
                       GetSQLValueString($_POST['nama'], "text"),
                       GetSQLValueString($_POST['nokp'], "text"),
                       GetSQLValueString($_POST['jawatan'], "text"),
                       GetSQLValueString($_POST['gred'], "text"),
...
$colname_viewuser = "-1";
if (isset($_GET['usrId'])) {
  $colname_viewuser = $_GET['usrId'];
}
mysql_select_db($database_kcon, $kcon);
$query_viewuser = sprintf("SELECT * FROM users WHERE usrId = %s", GetSQLValueString($colname_viewuser, "int"));
$viewuser = mysql_query($query_viewuser, $kcon) or die(mysql_error());
$row_viewuser = mysql_fetch_assoc($viewuser);
$totalRows_viewuser = mysql_num_rows($viewuser);
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a class="btn btn-success" href="daftar_user.php">
               <i class="ion ion-ios-paper-outline "></i> Tambah User
             </a>
            ...
            <div class="box-body">
              <form method="POST" action="<?php echo $editFormAction; ?>" role="form" name="formUser" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                        	 <div class="col-md-1">
                                             <label>Id</label>
                                             <input class="form-control" name="id" value="<?php echo $row_viewuser['usrId']; ?>" readonly >
                                             </div>
                                         ...
                                         <div class="form-group">
                                         	<div class="col-md-4">
                                             <label>Nama</label>
                                             <input name="nama" class="form-control" value="<?php echo $row_viewuser['usrName']; ?>">
                                             </div>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input name="nokp" type="text" class="form-control" placeholder="XXXXX-XX-XXXX" value="<?php echo $row_viewuser['usrIcNo']; ?>">
                                             </div>
                                         </div>
                                         ...
                                         <div class="form-group">
                                         	<div class="col-md-3">
                                            		 <label>Jawatan</label>
                                            		 <input  name="jawatan" type="text" class="form-control" value="<?php echo $row_viewuser['Jawatan']; ?>">
                                             </div>
                                             <div class="col-md-2">
                                             <label>Gred Jawatan</label>
                                             <input name="gred"  type="text" class="form-control" value="<?php echo $row_viewuser['GredJawatan']; ?>">
                                     ...
                                     <div class="form-group">
                                         <div class="col-md-2">
                                             ...
                                             <option value="<?php echo $row_viewuser['userUnit']; ?>"><?php echo $row_viewuser['userUnit']; ?></option>
                                         ...
                                         <div class="col-md-2">
                                                ...
                                                <select name="group" class="form-control">
                                             	<option value="<?php echo $row_viewuser['usersgroups']; ?>"><?php echo $row_viewuser['usersgroups']; ?></option>
