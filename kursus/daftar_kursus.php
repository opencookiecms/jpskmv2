...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formKursus")) {
  $insertSQL = sprintf("INSERT INTO kursus (KusName, KusBegin, kusEnd, kusTempat, kusTahun, kurHari) VALUES (%s, %s, %s, %s, %s, %s)",
              ...
              <div class="box-body">
                <form method="POST" action="<?php echo $editFormAction; ?>" role="form" name="formKursus" class="form-horizontal">
                                         ...
                                         <div class="form-group">
                                             ...
                                             <input class="form-control" name="tjKursus">
                                             </div>
                                          ...
                                          <div class="form-group">
                                         	<div class="col-md-5">
                                             <label>Tempat</label>
                                             <textarea class="form-control" placeholder="Tempat kursus" name="tKursus"></textarea>
                                             </div>
                                         </div>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <input class="form-control"  type="text" name="tTamat" id=date2>
                                     ...
                                     <div class="form-group">
                                         ...
                                         <div class="col-md-1">
                                             ...
                                             <input class="form-control" placeholder="hari" type="text" name="tHari">
                                             </div>
