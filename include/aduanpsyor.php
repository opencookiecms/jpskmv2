<form method="POST" action="<?php echo $editFormAction; ?>" role="form" name="formupdate" class="form-horizontal">
  ...
  <div class="form-group">
    <div class="col-md-3">
      ...
      <input name="kosSyor" type="text" placeholder="RM:" class="form-control">
    </div>

    <div class="col-md-3">
      <label>Pegawai Pengesyor</label>
      <input type="text" name="PSSyor" type="text" class="form-control" value="<?php echo $row_updateview['userFname']; ?>">
    </div>

    <div class="col-md-3">
      <label>Tarikh</label>
      <input name="dateSyor" type="text" id='date' class="form-control">
    </div>
  </div>
  <div class="form-group">
    <div class="col-md-3">
      ...
      <select class="form-control" name="astatus">
        ...
        <option value="Dalam Tindakan">Siasat Semula</option>
