<?php
    ...
    if (empty($ExcelFile)) {
      $Emessage = "Sila masukan fail berformat excel";
    }
    else
    {
      ...
      if(in_array($ExcelExt, $valid_Excel)){
        if($ExcelSize <100000000) {
          ...
          $Emessage = "Maaf fail saiz tidak mengikut spesifikasi";
        }
      }

      else {
        $Emessage = "Sila pastikan fail yang hendak diupload hanya dalam format .xslx";
      }
    }

    if(!isset($Emessage))
    {
      $stmt = $DB_con->prepare('INSERT INTO projeknegeri(Bulan, Catatan, Tahun, File) VALUES(:bulans, :catatans, :tahuns, :excels)');
      $stmt->bindParam(':bulans',$bulanbulan);


      $stmt->bindParam(':catatans',$catatan);
      $stmt->bindParam(':tahuns',$tahun);
      $stmt->bindParam(':excels',$excelRen);

      if($stmt->execute())
      {
        $SMessage = "Data berjaya dimasukan";
        header("refresh:2;Nprojek");
      }
      else
      {
        $Emessage = "Data gagal dimasukan";
      }
    }
  }
              ...
              <form method="POST" class="form-horizontal" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                             ...
                                             <div class="col-md-3">
                                               <label>Tahun</label>
                                          	   <input class="form-control" name="pNTahun">
                                             </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                          	<div class="col-md-5">
                                            	...
                                            	<textarea class="form-control" name="pNcatatan"></textarea>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                              <div class="col-md-3">
                                        ...
                                        <button type="submit" name="butangsimpan" class="btn btn-success">Simpan</button>
