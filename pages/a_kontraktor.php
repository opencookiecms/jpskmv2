...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "conform")) {

  $src=$_FILES['file']['tmp_name'];
  $gambar="../assets/images/userimage/".$_FILES['file']['name'];
  copy($src,$gambar);

  $insertSQL = sprintf("INSERT INTO kontraktor (konName, konImage, KonAlamat, konAlamatExtS, konAlamatExtD, konPoskod, konBandar, konDaerah, konNegeri, konTel, konPengurus, NoKPpengurus, NoTelPengurus, RKsatu, RKsatuNokp, RKsatuNotel, RKdua, RKduaNokp, RKduaNotel, RKtiga, RKtigaNokp, RKtigaNotel, RKempat, RKempatNokp, RKempatNotel, konEmail, koFax, konBank, konAkaunBank, konKawOperasi, konPrestasi, spPBaharu, spPembaharuan, spLainLain, spKategori, spDateMohon, spCaj, spNoResit, spNoSijil, spDateKeluar, spDateTamat, spDisemak, spJwtnPenyemak, spDisah, spJwtnSah, spLulus, spJwtnLulus, sijilNoPendaftaran, sijilSah, sijilTamat, sijilPPKGredOne, sijilPPKCatOne, sijilPPKKhuOne, sijilPPKGredTwo, sijilPPKCatTwo, sijilPPKKhuTwo, sijilPPKGredThree, sijilPPKCatThree, sijilPPKKhuThree, sijilSPKKNo, sijilSPKKsah, sijilSPKKTamat, sijilSPPKGredOne, sijilSPPKCatOne, sijilSPPKKhuOne, sijilSPPKGredTwo, sijilSPPKCatTwo, sijilSPPKKhuTwo, sijilSPPKGredThree, sijilSPPKCatThree, sijilSPPKKhuThree, sijiSTBNo, sijilSTBSah, sijilSTBTamat, sijilSTBGred, daftarSSM, daftarHSSM, daftarTSSM, daftarGST,dateDGST,dateTGST, sijilJPSNo, sijilJPSSah, sijilJPSTamat, sijilJPSKate) VALUES (%s, '$gambar', %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s,%s,%s)",
  GetSQLValueString($_POST['konNama'], "text"),
  //GetSQLValueString($_POST['koonImage'], "text"),
  ...
  GetSQLValueString($_POST['koonAkaunBank'], "int"),
  ...
  GetSQLValueString($_POST['daftarMohon'], "date"),
  ...
  GetSQLValueString($_POST['daftarKeluarkan'], "date"),
  GetSQLValueString($_POST['daftarTamat'], "date"),
  ...
  GetSQLValueString($_POST['sijilHinggaPPK'], "date"),
  ...
  GetSQLValueString($_POST['sijilHinggaSPKK'], "date"),
...
<body class="hold-transition skin-blue sidebar-mini">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <?php switch($role):
            ...
            <li class="active"><a href="../pages/kontraktor"><i class="fa fa-circle-o text-yellow"></i> <span>Senarai kontraktor</span></a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Kontraktor</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="box-body">
                  ...
                  ?>
                  <form method="POST" action="<?php echo $editFormAction; ?>" role="form" name="conform" class="form-horizontal" enctype="multipart/form-data">

                    <?php include '../include/konform.php';?>
  ...
  $(document).ready(function() {
    $('#txtsijilsatu').keyup(function(e) {
        var txtVal = $(this).val();
        $('#txtsijildua').val(txtVal);
    });

    $('#txtsijildua').keyup(function(e) {
        var txtVal = $(this).val();
        $('#txtsijilsatu').val(txtVal);
    });
  ...
  <script>
  $(document).ready(function() {
    $('#txtpkksatu').keyup(function(e) {
        var txtVal = $(this).val();
        $('#txtpkkdua').val(txtVal);
    ...
    $('#txtpkkdua').keyup(function(e) {
        var txtVal = $(this).val();
        $('#txtpkksatu').val(txtVal);
    });
