...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "projekperuntuakn")) {
  $updateSQL = sprintf("UPDATE projekatergori SET category=%s, Catatan=%s, kosperuntukan=%s WHERE catId=%s",
  ...
  $updateGoTo = "projekperuntukanview.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_peruntukan = "-1";
if (isset($_GET['catId'])) {
  $colname_peruntukan = $_GET['catId'];
}
mysql_select_db($database_dbconn, $dbconn);
$query_peruntukan = sprintf("SELECT * FROM projekatergori WHERE catId = %s", GetSQLValueString($colname_peruntukan, "int"));
$peruntukan = mysql_query($query_peruntukan, $dbconn) or die(mysql_error());
$row_peruntukan = mysql_fetch_assoc($peruntukan);
$totalRows_peruntukan = mysql_num_rows($peruntukan);
            ...
            <div class="box box-primary">
              ...
              <div class="box-body">
                <form method="POST" action="<?php echo $editFormAction; ?>" role="form" name="projekperuntuakn" class="form-horizontal">
                                    		<input type="text" name="id" class="form-control hidden" value="<?php echo $row_peruntukan['catId']; ?>">
                                          <div class="form-group">
                                           <div class="col-lg-4">
                                              <label>Jenis Peruntukan</label>

                                              <input name="peruntukantajuk" required class="form-control" placeholder="" value="<?php echo $row_peruntukan['category']; ?>" >
                                          ...
                                          <div class="form-group">
                                               ...
                                               <div class="col-md-4">
                                                <label>Catatan</label>
                                            	     <textarea class="form-control" placeholder="catatan" name="catatan"><?php echo $row_peruntukan['Catatan']; ?></textarea>
                                              </div>
                                          ...
                                          <div class="form-group">
                                                 ...
                                                 <label>Kos Peruntukan</label>
                                            	   ...
                                            	   <input class="form-control" placeholder="Kos Peruntukan" type="text" name="prkotsebut" value="<?php echo $row_peruntukan['kosperuntukan']; ?>">
                                          ...
                                          <input type="hidden" name="MM_update" value="projekperuntuakn">
