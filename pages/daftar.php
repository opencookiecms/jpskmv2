...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formUser")) {
  $insertSQL = sprintf("INSERT INTO users (userFname, userName, usersTel, usersEmail, usersPassword, UserJawatan, userRole) VALUES (%s, %s, %s, %s, %s, %s, %s)",
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
                                       ...
                                       <input class="form-control" name="username" type="text" id="username" class="demoInputBox" onBlur="checkAvailability()" placeholder="Username">
                                           </div>
                                           </div>
                                       </div>
                                       <div class="form-group">
                                       ...
                                       <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                         <div class="col-md-3">
                                           ...
                                           <input class="form-control" placeholder="Sila masukkan kata laluan" name="password" type="password">
                                           </div>
                                       </div>
                                       ...
                                       <div class="form-group">
                                         <div class="col-md-3">
                                              <label>No Tel</label>
                                              <input class="form-control"  name="notel" type="text" placeholder="xxx-xxxxxxx">
                                           </div>
                                           <div class="col-md-4">
                                           <label>Email</label>
                                           <input class="form-control" type="email" name="email"  placeholder="jps@jps.com.my">
