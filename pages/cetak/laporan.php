...
if (isset($_GET['aDaerah'])) {
  $colname_print = $_GET['aDaerah'];
}
mysql_select_db($database_dbconn, $dbconn);
$query_print = sprintf("SELECT * FROM aduan WHERE aDaerah = %s", GetSQLValueString($colname_print, "text"));
...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="100mm">
 ...
 <table class="tg">
  <tr>
    ...
    <th class="tg-wr85" colspan="5" style="border-right:none;">LAPORAN TERPERINCI PENGADUAN AWAM TAHUN 2018<br>JPS KUALA MUDA/SIK/BALING<br>(<span style="text-transform:uppercase"><?php echo $row_print['aDaerah']; ?>)</span><br></th>
  ...
  <tr>
    ...
    <td class="tg-xwic">TAJUK ADUAN<br></td>
    ...
    <td class="tg-xwic">PEGAWAI<br></td>
  ...
  <?php $bil +=1 ?>
    ...
    <td class="tg-yw4l" width="20"><?php echo $row_print['aKod']; ?></td>
    ...
    <td class="tg-yw4l" width="10"><?php echo $row_print['adKepada']; ?></td>
    <td class="tg-yw4l"></td>
