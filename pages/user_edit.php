...
if(!isset($_SESSION['sess_userFirstName']) || $role!="user" && $role!="adminaduan" && $role!="specialuser" && $role!="adminpengesyor" && $role!="adminkontraktor"){
...
if (isset($_GET['userFname'])) {
  $colname_userviewid = $_GET['userFname'];
}
mysql_select_db($database_dbconn, $dbconn);
$query_userviewid = sprintf("SELECT * FROM users WHERE userFname = '$userFname'", GetSQLValueString($colname_userviewid, "text"));
              ...
              <form method="POST" action="<?php echo $editFormAction; ?>" role="form" name="formUser" class="form-horizontal">
                ...
                <div class="form-group">
                  <div class="col-md-2">
                    ...
                    <input name="group" class="form-control" class="form-control" value="<?php echo $row_userviewid['userRole']; ?>" readonly>
