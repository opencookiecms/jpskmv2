...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formpegesahan")) {
  $insertSQL = sprintf("INSERT INTO orangpenting (NamaO, JawatanO, GredJawatanO) VALUES (%s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['gjawatan'], "text"));

  mysql_select_db($database_dbconn, $dbconn);
  $Result1 = mysql_query($insertSQL, $dbconn) or die(mysql_error());

  $insertGoTo = "pengesahan.php";
  if (isset($_SERVER['QUERY_STRING'])) {
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="POST" action="<?php echo $editFormAction; ?>" role="form" name="formpegesahan" class="form-horizontal">
            <div class="box-body">
                                       ...
                                       <div class="form-group">
                                         <div class="col-md-3">
                                              <label>Jawatan</label>
                                              <input class="form-control"  name="jawatan" type="text" placeholder="Jawatan">
                                           </div>
                                   ...
                                   <div class="form-group">
                                       <div class="col-md-2">
                                           ...
                                           <input name="gjawatan" class="form-control" placeholder="Gred Jawatan">
                                    ...
                                    <div class="box-footer">
                                       ...
                                       <input type="hidden" name="MM_insert" value="formpegesahan" />
                                   </form>
          </div>
          <!-- /.box -->
        </div>
